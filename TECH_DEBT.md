...
|---|---|---|---|---|
| P1 | `CODE_READY` | Ограничить время остановки `celery_beat` при deploy | Исправление подготовлено в PR `#261`, но его старый CI завершился ошибкой объединения coverage до исправления CI в PR `#259` | Перенести PR `#261` на актуальный `main`, получить один полный зелёный CI, выложить и проверить release-script |
