...
import { MarketplaceCatalogSettingsSections } from '@/components/marketplaces/MarketplaceCatalogSettingsSections';
import type {
  AutoloadOnboarding,
  AvitoAccountHealth,
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as SettingsTab)}>
        ...
        <MarketplaceCatalogSettingsSections
          categoryProvider={categoryMarketplace}
          pricingProvider={pricingMarketplace}
          categories={catalogCategories}
          ozonAccounts={ozonAccounts}
          loadingCategories={loadingCatalogCategories}
          loadingAccounts={loadingAccounts}
          canManage={canManageMarketplaceAccounts}
          ozonConnectionEnabled={isOzonConnectionEnabled}
          savingCategoryId={savingCatalogCategoryId}
          onCategoryProviderChange={setCategoryMarketplace}
          onPricingProviderChange={setPricingMarketplace}
          onToggleAvitoCategory={(categoryId) => {
            const currentCategory = catalogCategories.find((item) => item.id === categoryId);
            if (currentCategory) void toggleCatalogCategory(currentCategory);
          }}
          onReloadCategories={loadCatalogCategories}
        />
