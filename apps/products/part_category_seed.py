...
BASE_PART_CATEGORY_TREE = [
    {
        ...
        'children': [
            ('Тормозные колодки', ['Колодки', 'Колодка тормозная', 'Тормозные колодки дисковые', 'Brake pads'], True),
            ('Тормозные диски', ['Диски тормозные', 'Диск тормозной', 'Диск торм.', 'Тормозной диск', 'Brake discs'], True),
    ...
    },
    {
        ...
        'children': [
            ('Амортизаторы', ['Стойки амортизатора', 'Амортизатор подвески', 'Стойка амортизационная', 'Shock absorbers'], True),
            ...
            ('Рулевые тяги и наконечники', ['Наконечник рулевой', 'Рулевая тяга', 'Тяга рулевая', 'Наконечник рулевой тяги', 'Tie rods'], True),
            ('Ступицы и подшипники', ['Подшипник ступицы', 'Ступица', 'Ступичный узел', 'Ступица в сборе', 'Ступица колеса', 'Wheel bearing'], True),
    ...
    },
    {
        ...
        'children': [
            ...
            ('Прокладки двигателя', ['Прокладка ГБЦ', 'Прокладка клапанной крышки', 'Прокладка крышки', 'Gaskets'], True),
    ...
    },
    {
        ...
        'children': [
            ...
            ('Воздушные фильтры', ['Фильтр воздушный', 'Воздушный фильтр', 'Резонатор воздушного фильтра', 'Air filter'], True),
