...
Avito принимает переданный Brand только из своего каталога. Обязательность
зависит от листа категории и берётся из user-docs schema. Написание Avito нормализует сам (регистр,
