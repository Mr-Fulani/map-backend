...
Историческая инвентаризация M0–O1c: 2026-08-29–30.
Навигация актуализирована: 2026-09-06.

> Текущее состояние — [OZON_STATUS.md](OZON_STATUS.md). Ozon уже подключён и
> публикация доступна в AlfaPro; логи и диагностика выложены. Статусы ниже,
> отсутствие ключа/provider calls и ранние требования полей описывают соответствующий
> исторический этап. Они не являются текущими ограничениями и не заменяют
> актуальную схему Ozon или разрешение на внешние действия.

Исторический статус: M0 `VERIFIED`, M1a `ENABLED`, M1b `ENABLED`,
