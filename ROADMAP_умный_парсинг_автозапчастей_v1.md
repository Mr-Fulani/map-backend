...
> **Статус на 28.05.2026:** MVP-ядро реализовано частично/преимущественно; нужен отдельный этап для platform-level справочника авто и глобального индекса применяемости
